...
<body>
    <div class="main">
        ...
        <form action="register_post.php" method="POST">
            ...
            <select name='gender' titel='gender choosr male or female'>
            ...
            <input type="submit" name="submit" id="submit" value="Register" re><br>
        </form>
        <h3>OR</h3>
        <br>
